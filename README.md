...
7. Run `docker compose up` to create and run all containers. (Note: To run a specific service, refer to [this section](#useful-commands)).
8. Point your browser to http://localhost:3000 to access the frontend.
9. Point your browser to http://localhost:5000 to access the backend.
