...
5. Run `mkdir pgdata` (This will create a directory that is used to store data generated by `db` container).
6. Run `docker compose up` (Note: This will create and start up all containers. To run a specific service, refer to [this section](https://github.com/CrownKira/digitalace#useful-commands)).
